export const CATEGORY_KEYS = ['new', 'existing'] as const;
export const LEGACY_CATEGORY_VALUES = ['newChannels', 'existingChannels'] as const;
export const PERIOD_VIEWS = ['week', 'mtd', 'ytd'] as const;

export type CategoryKey = (typeof CATEGORY_KEYS)[number];
export type LegacyCategoryValue = (typeof LEGACY_CATEGORY_VALUES)[number];
